...
$cfg_cmspath = '';
$cfg_cookie_encode = 'PunecgPAgxRfo8qC3CuL1bnBQgkq';
$cfg_indexurl = '/';
$cfg_backup_dir = 'backupdata';
$cfg_indexname = '首页';
$cfg_webname = 'U盘装系统_好用官网_视频教程_好用u盘启动盘制作工具';
...
$cfg_multi_site = 'N';
$cfg_dede_log = 'N';
$cfg_powerby = 'Copyright (C) 2012 <a href="/" target=_blank>好用u盘启动盘制作工具</a> <a href=/data/rssmap.html target=_blank>网站地图</a> Allright Reserved.';
$cfg_arcsptitle = 'N';
$cfg_arcautosp = 'N';
...
$cfg_rewrite = 'N';
$cfg_delete = 'Y';
$cfg_keywords = 'u盘装系统,u盘启动盘制作工具,怎么用U盘装系统,好用U盘装系统';
$cfg_description = '好用u盘装系统教您怎么用u盘装系统,如何用u盘装系统教程、视频、图解、步骤,免费提供好用U盘启动盘制作工具,一键制作万能启动u盘,pe启动盘制作工具,U盘装win7，(一键U盘装系统)，让您快速完成xp系统安装。';
$cfg_beian = '蜀ICP备xxxxxxxx号 ';
$cfg_need_typeid2 = 'Y';
$cfg_cache_type = 'id';
$cfg_max_face = 50;
$cfg_typedir_df = 'Y';
